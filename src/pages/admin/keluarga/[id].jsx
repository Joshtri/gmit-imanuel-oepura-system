...
import { ArrowLeft, Users, MapPin, Home, User, Phone, Calendar, Heart, GraduationCap, Briefcase } from "lucide-react";
...
export default function KeluargaDetailPage() {
  ...
  const { data: keluargaData, isLoading, error } = useQuery({
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-900 font-medium">{keluarga.noBagungan || "-"}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-900">{keluarga.rayon?.namaRayon || "-"}</p>
              </div>
              ...
              {keluarga.alamat && (
                <div>
                  ...
                  <div className="text-gray-900 text-sm">
                    ...
                    <p>RT {keluarga.alamat.rt}/RW {keluarga.alamat.rw}</p>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <div className="space-y-2">
                        <div>
                          ...
                          <span className="ml-2 text-gray-900">{kepalaKeluarga.nama}</span>
                        </div>
                        <div>
                          <span className="text-sm font-medium text-gray-700">Jenis Kelamin:</span>
                          <span className="ml-2 text-gray-900">
                            {kepalaKeluarga.jenisKelamin ? "Laki-laki" : "Perempuan"}
                          </span>
                        </div>
                        <div>
                          ...
                          <span className="ml-2 text-gray-900">
                            {kepalaKeluarga.tanggalLahir 
                              ? new Date(kepalaKeluarga.tanggalLahir).toLocaleDateString("id-ID")
                              : "-"}
                          </span>
                        </div>
                      </div>
                    ...
                    <div>
                      <div className="space-y-2">
                        <div>
                          <span className="text-sm font-medium text-gray-700">Pekerjaan:</span>
                          <span className="ml-2 text-gray-900">{kepalaKeluarga.pekerjaan?.namaPekerjaan || "-"}</span>
                        </div>
                        <div>
                          <span className="text-sm font-medium text-gray-700">Pendidikan:</span>
                          <span className="ml-2 text-gray-900">{kepalaKeluarga.pendidikan?.jenjang || "-"}</span>
                        </div>
                        <div>
                          <span className="text-sm font-medium text-gray-700">No. HP:</span>
                          <span className="ml-2 text-gray-900">{kepalaKeluarga.noHp || "-"}</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {anggotaKeluarga.map((jemaat, index) => (
                    <div key={jemaat.id} className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <div className="space-y-2">
                            <div>
                              <span className="text-sm font-medium text-gray-700">Nama:</span>
                              <span className="ml-2 text-gray-900 font-medium">{jemaat.nama}</span>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-700">Status:</span>
                              <span className="ml-2 text-gray-900">{jemaat.statusDalamKeluarga?.status || "-"}</span>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-700">Jenis Kelamin:</span>
                              <span className="ml-2 text-gray-900">
                        ...
                        <div>
                          <div className="space-y-2">
                            <div>
                              <span className="text-sm font-medium text-gray-700">Pekerjaan:</span>
                              <span className="ml-2 text-gray-900">{jemaat.pekerjaan?.namaPekerjaan || "-"}</span>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-700">Pendidikan:</span>
                              <span className="ml-2 text-gray-900">{jemaat.pendidikan?.jenjang || "-"}</span>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-700">No. HP:</span>
                              <span className="ml-2 text-gray-900">{jemaat.noHp || "-"}</span>
                            </div>
                            {jemaat.statusNikah && (
                              <div>
                                <span className="text-sm font-medium text-gray-700">Status Nikah:</span>
                                <span className="ml-2 text-gray-900">{jemaat.statusNikah?.status || "-"}</span>
                              </div>
                            )}
                          </div>
                        </div>
