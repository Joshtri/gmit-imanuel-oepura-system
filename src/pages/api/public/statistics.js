...
async function handler(req, res) {
  ...
  try {
    ...
    const jemaatByAgeGroup = Object.entries(ageGroups).map(([age_group, count]) => ({
      age_group,
      count
    }));
      ...
      charts: [
        ...
        },
        {
          ...
          data: jemaatByAgeGroup.map((item, index) => ({
            name: item.age_group,
            value: item.count,
            color: ['#10B981', '#F59E0B', '#8B5CF6', '#06B6D4', '#84CC16'][index % 5]
          }))
        },
        {
          ...
          data: rayonData.map((item, index) => ({
            ...
            color: ['#EF4444', '#F97316', '#F59E0B', '#84CC16', '#22C55E'][index % 5]
          }))
        },
        {
